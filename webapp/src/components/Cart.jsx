...
const Cart = ({ cartItems, removeFromCart }) => {
  ...
  return (
    <div className="w-full lg:w-1/3 bg-gray-900 text-white p-4 rounded-lg lg:ml-4 mt-4 lg:mt-0">
      ...
      <div className="border-t border-gray-700 pt-4 mt-4">
        ...
        <button className="bg-yellow-500 text-black px-4 py-2 rounded mt-2">Order</button>
      </div>
    </div>
  );
};
